...
def getMouse(event):
    x = frame.winfo_pointerx()- 540
    y = frame.winfo_pointery()-70
    print(x,y)
...
# Button
buttonRundeBeenden = Button(master=root, text='Runde beenden', bg='#008800', font=('Arial', 20), command=getMouse)
...
buttonUnit1 = Button(master=root, image=unit1, command='')
